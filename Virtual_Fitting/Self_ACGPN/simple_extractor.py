...
def get_arguments():
    ...
    parser.add_argument("--input-dir", type=str, default='/home/jykim/JY_project/Project/Fashine/ACGPN/Data_preprocessing/test_img', help="path of input image folder.")
    parser.add_argument("--output-dir", type=str, default='/home/jykim/JY_project/Project/Fashine/ACGPN/Data_preprocessing/test_label', help="path of output image folder.")
